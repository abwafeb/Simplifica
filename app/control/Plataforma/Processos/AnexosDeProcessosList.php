 ...
 */
class anexosDeProcessosList extends TWindow
{
    private $form; // form
    ...
    {
            $filter = new TFilter('processo_id', '=', $param['key']);
            TSession::setValue('AnexosProcessosList_filter', $filter);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            if (TSession::getValue('AnexosProcessosList_filter'))
            {
                $criteria->add(TSession::getValue('AnexosProcessosList_filter'));
            }
